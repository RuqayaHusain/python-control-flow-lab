...
def check_letter():
    ...
    VOWELS = ['a', 'e', 'i', 'o', 'u']
    letter = input('kindly enter a letter (a-z or A-Z): ').lower()
...
def calculate_dog_years():
    ...
    if dog_age < 0:
        ...
        actual_age = 20 + (dog_age - 2) * 7
    else: 
        actual_age = dog_age * 10

    print(f"The dog's age in dog years is {actual_age}.")
# Call the function
calculate_dog_years()
...
def determine_season():
    ...
    if month in ('jan', 'feb'):
        ...
        season = 'Winter' if day_of_month < 20 else 'Spring'
    elif month in ('apr', 'may'):
        season = 'Spring'
    elif month == 'jun':
        season = 'Spring' if day_of_month < 21 else 'Summer'
    elif month in ('jul', 'aug'):
        season = 'Summer'
    elif month == 'sep':
        season = 'Summer' if day_of_month < 22 else 'Fall'
    elif month in ('oct', 'nov'):
        season = 'Fall'
    elif month == 'dec':
        season = 'Fall' if day_of_month < 21 else 'Winter'
    else:
        print('Invalid month')
        return
